...
const getFooterEl = () => __awaiter(void 0, void 0, void 0, function* () {
    let count = 0;
    while (true) {
        yield sleep(1000);
        ...
        count += 1;
        if (count >= 10) {
            throw new Error('cannot find footer element');
        }
    }
});
...
const attachDisplay = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    el.id = DISPLAY_ID;
    const footerEl = yield getFooterEl();
    const getFontFamily = () => {
        if (!(footerEl.childNodes[0] instanceof HTMLElement)) {
            return FONT_FAMILY;
        }
        const styles = window.getComputedStyle(footerEl.childNodes[0]);
