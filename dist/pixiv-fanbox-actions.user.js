...
const getArticle = async () => {
    const el = await (0,_sapphire_sh_utils_browser__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('article');
    if (el === null) {
...
const main = async () => {
    ...
    (0,_sapphire_sh_utils_browser__WEBPACK_IMPORTED_MODULE_0__.interceptXHR)(/post\.info/, (xhr) => {
