...
const getTitle = (text) => `${text} - ${document.title}`;
const getTableEl = async () => {
    const el = await (0,_sapphire_sh_utils_browser__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('.item-detail.__light table');
    if (el === null) {
