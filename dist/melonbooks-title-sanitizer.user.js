// ==UserScript==
// @name         melonbooks title sanitizer
// @namespace    https://www.sapphire.sh/
// @description  melonbooks title sanitizer
// @match        https://www.melonbooks.co.jp/*
// @grant        none
// @author       sapphire
// @downloadURL  https://github.com/sapphire-sh/UserScripts/raw/release/dist/melonbooks-title-sanitizer.user.js
// @updateURL    https://github.com/sapphire-sh/UserScripts/raw/release/dist/melonbooks-title-sanitizer.user.js
// @version      1766589106377
// ==/UserScript==
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
/***/ "./src/scripts/melonbooks-title-sanitizer.ts":
/*!***************************************************!*\
  !*** ./src/scripts/melonbooks-title-sanitizer.ts ***!
  \***************************************************/
...
const getTableEl = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield getElement('.item-detail.__light table');
});
const getCircleName = (tableEl) => {
    var _a, _b, _c;
    const tableRowEls = Array.from(tableEl.querySelectorAll('tr'));
    for (const tableRowEl of tableRowEls) {
        if (((_a = tableRowEl.querySelector('th')) === null || _a === void 0 ? void 0 : _a.textContent) !== 'サークル名') {
            continue;
        }
        return (_c = (_b = tableRowEl.querySelector('a')) === null || _b === void 0 ? void 0 : _b.textContent) !== null && _c !== void 0 ? _c : null;
    }
    return null;
};
const getArtistName = (tableEl) => {
    var _a, _b, _c;
    const tableRowEls = Array.from(tableEl.querySelectorAll('tr'));
    for (const tableRowEl of tableRowEls) {
        if (((_a = tableRowEl.querySelector('th')) === null || _a === void 0 ? void 0 : _a.textContent) !== '作家名') {
            continue;
        }
        return (_c = (_b = tableRowEl.querySelector('a')) === null || _b === void 0 ? void 0 : _b.textContent) !== null && _c !== void 0 ? _c : null;
    }
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    const tableEl = yield getTableEl();
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/scripts/melonbooks-title-sanitizer.ts");
/******/ 	
/******/ })()
;