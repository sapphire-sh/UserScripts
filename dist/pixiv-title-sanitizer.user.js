...
const getTitle = async () => {
    const el = await (0,_sapphire_sh_utils_browser__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('figcaption h1');
    if (el === null) {
...
const getAuthor = async () => {
    const el = await (0,_sapphire_sh_utils_browser__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('a[href^="/users/"] + div > a');
    if (el === null) {
