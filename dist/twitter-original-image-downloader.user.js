...
const getFormat = () => __awaiter(void 0, void 0, void 0, function* () {
    const el = yield (0, helpers_1.waitForElement_)('[property="og:image"]');
    if (!el) {
        return;
    }
...
const generateHandler = (images, format) => {
...
const getArticles = () => __awaiter(void 0, void 0, void 0, function* () {
    const articles = yield (0, helpers_1.waitForElements)('article');
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const format = (_a = (yield getFormat())) !== null && _a !== void 0 ? _a : 'jpg';
