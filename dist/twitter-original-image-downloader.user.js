...
const _getFormat = async () => {
    const el = await (0,_sapphire_sh_utils__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('[property="og:image"]');
    if (el === null) {
...
const getArticles = async () => {
    const articles = await (0,_sapphire_sh_utils__WEBPACK_IMPORTED_MODULE_0__.waitForElements)(['article', '[data-testid="error-detail"]']);
...
const getImages = async (article) => {
    const images = await (0,_sapphire_sh_utils__WEBPACK_IMPORTED_MODULE_0__.waitForElements)('div[data-testid="tweetPhoto"] img', {
        parent: article,
    });
    return images;
};
