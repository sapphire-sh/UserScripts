...
const main = async () => {
    void updateTitle();
    {
        const iconEl = await (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.waitForElement)('[href="/home"][role="link"]:not([data-testid="AppTabBar_Home_Link"])');
    ...
    {
        const iconEl = await (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.waitForElement)('[rel="apple-touch-icon"]');
        const firstEl = iconEl.item(0);
    ...
    {
        const iconEl = await (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.waitForElement)('[rel="shortcut icon"]');
        const firstEl = iconEl.item(0);
        if (firstEl instanceof HTMLLinkElement) {
            firstEl.href = ICON_B;
        }
