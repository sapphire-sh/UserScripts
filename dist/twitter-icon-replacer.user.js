...
const main = async () => {
    void updateTitle();
    {
        const firstEl = await (0,_sapphire_sh_utils__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('[href="/home"][role="link"]:not([data-testid="AppTabBar_Home_Link"])');
        if (firstEl === null) {
    ...
    {
        const firstEl = await (0,_sapphire_sh_utils__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('[rel="apple-touch-icon"]');
        if (firstEl === null) {
    ...
    {
        const firstEl = await (0,_sapphire_sh_utils__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('[rel="shortcut icon"]');
        if (firstEl === null) {
