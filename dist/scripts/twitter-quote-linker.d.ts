...
declare const findDonorLink: (row: Element | null, fallbackRoot: HTMLElement) => HTMLAnchorElement | null;
declare const createLinkWrapper: (statusPath: string, donor: HTMLAnchorElement | null) => HTMLElement;
