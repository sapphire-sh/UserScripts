...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/scripts/twitter-original-image-replacer.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _sleep__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sleep */ "./src/helpers/sleep.ts");
...
(async () => {
    ...
    let target = null;
    do {
        await Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["sleep"])(1000);
