...
const main = async () => {
    const dataEl = await (0,_sapphire_sh_utils_browser__WEBPACK_IMPORTED_MODULE_0__.waitForElement)('#TheModel');
    if (dataEl === null) {
    ...
    for (const circle of data.Circles) {
        ...
        const circleEl = await (0,_sapphire_sh_utils_browser__WEBPACK_IMPORTED_MODULE_0__.waitForElement)(`[id="${Id}"]`);
        if (circleEl === null) {
